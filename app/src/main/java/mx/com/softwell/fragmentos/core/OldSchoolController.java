...
import mx.com.softwell.fragmentos.gui.LaViejaEscuela;
...
public class OldSchoolController {
    ...
    private static String TAG = "OldschoolJuegoController";
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                try{
                    ...
                    if (status){
                        ...
                        ((LaViejaEscuela) MainActivity.GLOBALS.get("viejaEscuelaFragment")).actualizar(juegos);
                    }else{
                        miscController.CloseWait();
                        Log.e(TAG, message);
                    }
